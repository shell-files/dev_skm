...
def ingestToPgvector():
    ...
    insertQuery = """
        INSERT INTO esg_chunks (
            ...
            sub_issue_id, sub_issue_name, best_sub_issue_id, best_similarity_score, chunk_embedding
    ...
    with open(similarityFile, "r", encoding="utf-8") as f:
        for line in f:
            ...
            recordData = (
                ...
                float(record.get("bestSimilarityScore", 0.0)) if record.get("bestSimilarityScore") is not None else 0.0,
