...
import {
  GROUP_META, GROUP_KEYS, GROUP_SCORE_KEY, URL_LABEL,
  ...
  return (
    <div id="survey-page" className="survey-container">
      ...
      <SurveyResultDashboard
        ...
        recalcDone={recalcDone}
        groups={groups}
        totals={totals}
        surveyTopIssues={surveyTopIssues}
        surveyResultLoading={surveyResultLoading}
        stakeholderTopIssues={stakeholderTopIssues}
      />
    </div>
  );
};
